...
SevenSegment.prototype.CharacterMasks = (function() {
    return {
        ...
        'b' : parseInt("1111100", 2),
        'c' : parseInt("1011000", 2),
        'd' : parseInt("1011110", 2),
        'e' : parseInt("1111001", 2),
        'f' : parseInt("1110001", 2),
        'g' : parseInt("1101111", 2),
        'h' : parseInt("1110100", 2),
        'i' : parseInt("0000100", 2),
        'j' : parseInt("0011110", 2),
        'l' : parseInt("0000110", 2),
        'n' : parseInt("1010100", 2),
        'o' : parseInt("1011100", 2),
        'p' : parseInt("1110011", 2),
        'r' : parseInt("1010000", 2),
        's' : parseInt("1101101", 2),
        't' : parseInt("1111000", 2),
        'u' : parseInt("0011100", 2),
        'y' : parseInt("1100110", 2),
